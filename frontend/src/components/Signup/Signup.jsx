        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-300 focus:outline-none focus:outline-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
            <div>
            ...
            <div>
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 group relative w-full h-[40px] flex justify-center py-2 border border-transparent text-sm font-medium rounded-md text-white"
              >
                Submit
              </button>
            </div>
