...
// import { Country, State } from "country-state-State";
...
const ProfileContent = ({ active }) => {
  ...
  const handleImage = async (e) => {
    ...
    formData.append("image", file); // Use "image" to match the server's expectation
  ...
  return (
    ...
    {open && (
      <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center">
        <div className="w-[70%] 800px:w-[35%]  h-[80vh] bg-white rounded shadow relative overflow-y-scroll">
          ...
          <div className="w-full">
            <form onSubmit={handleSubmit} className="w-full">
              <div className="w-full block p-4">
                ...
                <div className="w-full pb-2">
                  <button type="submit" className={`${styles.input} mt-5 cursor-pointer`}>
                    Save Address
                  </button>
                </div>
              </div>
          ...
          >
            ...
            <div className="pl-8 flex items-center">
              <h6 className="text-[12px] 800px:text-[unset]">
                {item.address1} {item.address2} {item.city} {item.state} {item.country}
              </h6>
            </div>
            <div className="pl-8 flex items-center">
              <h6 className="text-[12px] 800px:text-[unset]">
